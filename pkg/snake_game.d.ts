...
* @returns {World}
*/
  static new(width: number, snake_idx: number, snake_size: number): World;
/**
*/
  start_game(): void;
/**
...
* @returns {Uint32Array}
*/
  snake_cells(): Uint32Array;
/**
* @param {number} direction
*/
  change_shake_dir(direction: number): void;
/**
*/
  step(): void;
}
...
export interface InitOutput {
  ...
  readonly world_change_shake_dir: (a: number, b: number) => void;
