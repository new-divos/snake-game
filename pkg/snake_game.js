...
export class World {
    ...
    * @returns {World}
    */
    static new(width, snake_idx, snake_size) {
        var ret = wasm.world_new(width, snake_idx, snake_size);
    ...
    */
    change_shake_dir(direction) {
        wasm.world_change_shake_dir(this.ptr, direction);
    }
    /**
    */
    step() {
